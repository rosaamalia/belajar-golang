...
type User struct {
	...
	Photos			[]Photo			`gorm:"foreignKey:UserID; constraint:OnUpdate:CASCADE, OnDelete:SET NULL" json:"photos"`
	SocialMedias	[]SocialMedia	`gorm:"foreignKey:UserID; constraint:OnUpdate:CASCADE, OnDelete:SET NULL" json:"social_medias"`
}
